...
export const areaList: AreaList[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { value: '810015', label: '沙田区' },
      { value: '810016', label: '西贡区' },
      { value: '810017', label: '离岛区' },
      { value: '810018', label: '葵青区' },
    ],
  },
  {
    label: '澳门特别行政区',
    value: '820000',
    children: [
      { value: '820001', label: '澳门半岛' },
      { value: '820002', label: '氹仔岛' },
      { value: '820003', label: '路环岛' },
    ],
  },
  {
    label: '台湾省',
    value: '710000',
    children: [
      { value: '710001', label: '台北市' },
      { value: '710002', label: '高雄市' },
      { value: '710003', label: '台南市' },
      { value: '710004', label: '台中市' },
      { value: '710005', label: '金门县' },
      { value: '710006', label: '南投县' },
      { value: '710007', label: '基隆市' },
      { value: '710008', label: '新竹市' },
      { value: '710009', label: '嘉义市' },
      { value: '710010', label: '新北市' },
      { value: '710011', label: '宜兰县' },
      { value: '710012', label: '新竹县' },
      { value: '710013', label: '桃园县' },
      { value: '710014', label: '苗栗县' },
      { value: '710015', label: '彰化县' },
      { value: '710016', label: '嘉义县' },
      { value: '710017', label: '云林县' },
      { value: '710018', label: '屏东县' },
      { value: '710019', label: '台东县' },
      { value: '710020', label: '花莲县' },
      { value: '710021', label: '澎湖县' },
      { value: '710022', label: '连江县' },
    ],
  },
]
